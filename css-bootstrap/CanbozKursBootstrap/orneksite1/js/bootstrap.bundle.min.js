...
!function(t, e) {
  ...
  class Y extends j {
    ...
    static dataApiClickHandler(t) {
      ...
      const i = { ...B.getDataAttributes(e), ...B.getDataAttributes(this) }, n = this.getAttribute('data-bs-slide-to');
    ...
    name: 'arrow', enabled: !0, phase: 'main', fn: function(t) {
      ...
      if (o && r) {
        var d = function(t, e) {
          ...
          m = vt(o), _ = m ? 'y' === l ? m.clientHeight || 0 : m.clientWidth || 0 : 0, b = p / 2 - g / 2, v = d[f],
  ...
  function Kt(t, e) {
    ...
    var i = e, s = i.placement, n = void 0 === s ? t.placement : s, o = i.boundary,
      ...
      c = i.elementContext, d = void 0 === c ? 'popper' : c, h = i.altBoundary, f = void 0 !== h && h, u = i.padding,
      p = void 0 === u ? 0 : u, g = Lt('number' != typeof p ? p : Ot(p, tt)),
  ...
  function Yt(t, e) {
    ...
    var i = e, s = i.placement, n = i.boundary, o = i.rootBoundary, r = i.padding, a = i.flipVariations,
      l = i.allowedAutoPlacements, c = void 0 === l ? it : l, d = Ft(s), h = d ? a ? et : et.filter((function(t) {
        return Ft(t) === d;
    ...
    name: 'flip', enabled: !0, phase: 'main', fn: function(t) {
      ...
      if (!e.modifiersData[s]._skip) {
        for (var n = i.mainAxis, o = void 0 === n || n, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, d = i.boundary, h = i.rootBoundary, f = i.altBoundary, u = i.flipVariations, p = void 0 === u || u, g = i.allowedAutoPlacements, m = e.options.placement, _ = dt(m), b = l || (_ !== m && p ? function(t) {
          ...
          var O = v[L], k = dt(O), D = 'start' === Ft(O), x = [Q, G].indexOf(k) >= 0, C = x ? 'width' : 'height',
  ...
  var Qt = {
    ...
    name: 'preventOverflow', enabled: !0, phase: 'main', fn: function(t) {
      var e = t.state, i = t.options, s = t.name, n = i.mainAxis, o = void 0 === n || n, r = i.altAxis,
        a = void 0 !== r && r, l = i.boundary, c = i.rootBoundary, d = i.altBoundary, h = i.padding, f = i.tether,
        u = void 0 === f || f, p = i.tetherOffset, g = void 0 === p ? 0 : p,
        ...
        L = 'function' == typeof g ? g(Object.assign({}, e.rects, { placement: e.placement })) : g, O = { x: 0, y: 0 };
      if (E) {
        if (o || a) {
          var k = 'y' === y ? Q : J, D = 'y' === y ? G : Z, x = 'y' === y ? 'height' : 'width', C = E[y],
            S = E[y] + m[k], N = E[y] - m[D], j = u ? -A[x] / 2 : 0, P = 'start' === b ? T[x] : A[x],
            I = 'start' === b ? -A[x] : -T[x], M = e.elements.arrow, R = u && M ? ft(M) : { width: 0, height: 0 },
